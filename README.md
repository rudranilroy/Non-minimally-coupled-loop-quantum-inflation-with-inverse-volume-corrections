...
Rudranil Roy[![ORCID](https://orcid.org/assets/vectors/orcid.logo.icon.svg)](https://orcid.org/0000-0003-3114-419X) $^a$, Giovanni Otalora $^a$, Joel Saavedra $^b$, Salvatore Capozziello $^{c,d,e}$
